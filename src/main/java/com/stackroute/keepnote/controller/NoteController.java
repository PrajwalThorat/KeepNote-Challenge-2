...
public class NoteController {
	...
	/*
	 * @RequestMapping(value = "/updateNote") public String updateNote(@RequestParam
	 * int noteId, ModelMap model) { model.addAttribute("note",
	 * noteDao.getNoteById(noteId)); return "update"; }
	 */
